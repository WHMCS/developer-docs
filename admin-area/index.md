...
First, replace the `~/assets/img/whmcs.png` with your desired logo. Then in the custom admin template in the `~/admin/templates` folder, replace the `images/logo.gif` file.
